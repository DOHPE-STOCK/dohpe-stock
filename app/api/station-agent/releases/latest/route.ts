...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    release_notes: [
      'Runs Station Agent updates silently from inside the desktop app.',
      'Keeps existing station settings during automatic updates.',
      'Restarts Loopbase after the update installer finishes.',
    ],
  })
}
